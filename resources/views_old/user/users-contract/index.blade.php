                                ...
                                <x-modal id="exampleModalLarge" title="Form Contract" size="lg">
                                    <form action="{{ route('user-contract.store') }}" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="desc_constract" required rows="10" maxlength="1000"></textarea>
                                        </div>
                                        <div class="mb-3">
                    ...
                    <div class="table-responsive">
                                ...
                                @foreach ($userContracts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span
                                                    class="badge rounded-4 bg-warning fs-6 m-1">{{ Str::ucfirst($item->status_contract) }}</span>
                                            @endif
                                        </td>
                                        <td class="text-end">
                        ...
                        <x-modal id="modalEdits" title="Form Edit Contract" size="lg">
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    <label>Keterangan Contract</label>
                                    <textarea class="form-control" name="desc_constract" id="description" required rows="10" maxlength="1000"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label>File Contract</label>
                                    <input class="form-control" type="file" name="file"

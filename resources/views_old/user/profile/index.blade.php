                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 ms-auto align-self-center">
                                <ul class="list-unstyled personal-detail mb-0">
                                    <li class=""><i class="las la-phone mr-2 text-secondary font-22 align-middle"></i> <b>
                                            phone </b> : {{ Auth::user()->phone }}</li>
                                    <li class="mt-2"><i
                                    ...
                                    <li>
                                        ...
                                        @if($data)
                                            <div class="alert alert-success mt-2 fs-6">
                                                Silahkan download slip gaji anda pada bulan ini.
                                            </div>
                                        @else
                                            <div class="alert alert-danger mt-2 fs-6">
                                                slip gaji anda belum tersedia.
                                            </div>

                                        @endif
                                        {{-- <button class="btn btn-primary btn-sm mt-2 ms-4" type="button"
                                            onclick="window.location.href='{{ route('profile.slip.gaji') }}'">Download Slip
                                            Gaji</button> --}}
                                    </li>
                                </ul>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('profile.update', ['id' => Auth::user()->id]) }}"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label
                                                        class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center form-label">TTL</label>
                                                    <div class="col-lg-9 col-xl-8">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label
                                                        class="col-xl-3 col-lg-3 text-end mb-lg-0 align-self-center form-label">Kelamin</label>
                                                    <div class="col-lg-9 col-xl-8">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-8">
                                                        <textarea type="text" class="form-control" rows="3" name="address"
                                                            placeholder="Carolina, St"
                                                            aria-describedby="basic-addon1">{{ Auth::user()->address }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group mb-3 row">

            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    @if (Auth::user()->is_admin == 1)
                        <div>
                            <button class="btn btn-primary btn-sm ms-auto" type="button" onclick="location.href='{{ route('user-shift.index') }}'">See More</button>
                        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <button class="btn btn-primary btn-sm ms-auto" type="button" onclick="location.href='{{ route('attendance.list') }}'">See More</button>
                    </div>
                </div>
            </div>
            <div class="card-body">

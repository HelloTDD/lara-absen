!(function () {
  ...
  const b = {
      ...
      m(e, t, i) {
        ...
        return (
          s.setMonth(n), s.getMonth() !== x(n) ? s.setDate(0) : s.getTime()
        );
      },
  ...
  function G(t, s) {
    ...
    if (n.language) {
      ...
      if (
        (n.language !== c &&
          (r[n.language]
            ? (e = n.language)
            : ((e = n.language.split("-")[0]), void 0 === r[e] && (e = !1))),
        delete n.language,
        e)
      ) {
        c = a.language = e;
        ...
        (h = Object.assign({ format: P, weekStart: q }, r[I])),
          ...
          y === t.weekStart &&
            ((y = a.weekStart = h.weekStart), (a.weekEnd = U(h.weekStart)));
      }
    }
    if (n.format) {
    ...
    void 0 !== n.pickLevel && ((v = X(n.pickLevel, 2)), delete n.pickLevel),
      v !== g &&
        (v > g &&
          (void 0 === n.minDate && (n.minDate = p),
          void 0 === n.maxDate && (n.maxDate = u)),
    ...
    if (void 0 !== n.minDate) {
      const e = l(0, 0, 1);
      (b = null === n.minDate ? e : z(n.minDate, o, h, b)),
        b !== e && (b = w(b, g, !1)),
        delete n.minDate;
    }
    if (
      (void 0 !== n.maxDate &&
        ((k = null === n.maxDate ? void 0 : z(n.maxDate, o, h, k)),
        void 0 !== k && (k = w(k, g, !0)),
        delete n.maxDate),
      k < b
        ? ((p = a.minDate = k), (u = a.maxDate = b))
        : (p !== b && (p = a.minDate = b), u !== k && (u = a.maxDate = k)),
      n.datesDisabled &&
    ...
    if (void 0 !== n.weekStart) {
      ...
      isNaN(e) || ((y = a.weekStart = e), (a.weekEnd = U(e))),
        delete n.weekStart;
    }
    if (
      ...
      n.daysOfWeekHighlighted &&
        ((a.daysOfWeekHighlighted = n.daysOfWeekHighlighted.reduce(J, [])),
    ...
    n.dateDelimiter &&
      ((a.dateDelimiter = String(n.dateDelimiter)), delete n.dateDelimiter);
    let x = f;
    void 0 !== n.maxView && ((x = X(n.maxView, f)), delete n.maxView),
      (x = g > x ? g : x),
      x !== f && (f = a.maxView = x);
    let M = m;
    if (
      (void 0 !== n.startView && ((M = X(n.startView, M)), delete n.startView),
      M < g ? (M = g) : M > f && (M = f),
      M !== m && (a.startView = M),
      n.prevArrow)
    ) {
  ...
  class ie extends te {
    ...
    setOptions(t) {
      ...
      void 0 !== t.showDaysOfWeek &&
        (t.showDaysOfWeek
          ? (B(this.dow), this.calendarWeeks && B(this.calendarWeeks.dow))
          : (L(this.dow), this.calendarWeeks && L(this.calendarWeeks.dow))),
        i &&
  ...
  class ne extends te {
    ...
    init(e, t = !0) {
      t &&
        ...
        this.grid.appendChild(F(r("span", 12, { "data-month": (e) => e })))),
        super.init(e);
    }
    setOptions(t) {
      if (
  ...
  function ve(t, i) {
    if (
      (void 0 !== i.title &&
        (i.title
          ? ((t.controls.title.textContent = i.title), B(t.controls.title))
          : ((t.controls.title.textContent = ""), L(t.controls.title))),
      i.prevArrow)
    ) {
    ...
    if (
      ...
      void 0 !== i.todayBtn &&
        (i.todayBtn ? B(t.controls.todayBtn) : L(t.controls.todayBtn)),
    ...
    void 0 !== i.clearBtn &&
      (i.clearBtn ? B(t.controls.clearBtn) : L(t.controls.clearBtn));
  }
  function be(e) {
  ...
  function Me(e) {
    ...
    if (t !== document.body && t)
      return "visible" !== window.getComputedStyle(t).overflow ? t : Me(t);
  }
  class Se {
    constructor(e) {
      ...
      s.classList.add(`datepicker-${p}`),
        ...
        (this.views = [
          new ie(this),
          new ne(this),
          new ae(this, { id: 2, name: "years", cellClass: "year", step: 1 }),
          new ae(this, {
            id: 3,
            name: "decades",
            cellClass: "decade",
    ...
    show() {
      ...
      if (e.inline) t.classList.add("active");
        ...
        i !== xe(V(t)) ? (t.dir = i) : t.dir && t.removeAttribute("dir"),
    ...
    place() {
      ...
      "auto" === f &&
        (d < D
          ...
          : d + a > v
          ? ((f = "right"), v < c && (k = v - c))
          : (f = "rtl" === xe(n) ? (c - a < D ? "left" : "right") : "left")),
        "right" === f && (g += h - a),
        (g += k),
  ...
  function Ce(e, t, i, s) {
    ...
    (c = Oe(c, d, i < 0 ? -r : r, o, a.minDate, a.maxDate)),
  ...
  function He(e, t, i) {
    ...
    (d || r) &&
      (d && d.toString() !== e.dates.toString()
        ? ((e.dates = d), We(e, n ? 3 : 1), re(e, "changeDate"))
        : We(e, 1),
      a && e.hide());
  }
  class je {
    constructor(e, t = {}, i) {
      ...
      (this._options = t),
        ...
        a
          ? ((d = s(e.dataset.date, n.dateDelimiter)), delete e.dataset.date)
  ...
  (window.Datepicker = je),
    (window.DateRangePicker = class {
      constructor(e, t = {}) {
        ...
        Object.defineProperty(this, "datepickers", { get: () => a }),
          ...
          a[0].dates.length > 0
            ...
            : a[1].dates.length > 0 && Ke(this, { target: this.inputs[1] });
      }
      get dates() {
      ...
      getDates(e) {
        const t = e
          ? (t) => C(t, e, this.datepickers[0].config.locale)
          : (e) => new Date(e);
      ...
      setDates(e, t) {
        ...
        (this._updating = !0),
          ...
          s.dates[0] !== n[1]
            ...
            : i.dates[0] !== n[0] && Ke(this, { target: this.inputs[0] });
      }
    });
})();
